...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SWMM-X — Architecture Docs" },
      { name: "twitter:title", content: "SWMM-X — Architecture Docs" },
      { property: "og:description", content: "SWMM-X v1: project format, .inp compatibility, results Parquet, JSON Schema." },
      { name: "twitter:description", content: "SWMM-X v1: project format, .inp compatibility, results Parquet, JSON Schema." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/526a1908-3cd2-408a-8baf-2c9af9bd23d6/id-preview-203a3863--de84354d-11ac-42fb-b8c7-63b332073411.lovable.app-1782514763670.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/526a1908-3cd2-408a-8baf-2c9af9bd23d6/id-preview-203a3863--de84354d-11ac-42fb-b8c7-63b332073411.lovable.app-1782514763670.png" },
